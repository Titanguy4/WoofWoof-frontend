    ...
    return (
        ...
        >
            ...
            <View className="items-center w-full h-[56px] flex-row py-4">
                ...
                <Text className="text-xl text-white font-manropeBold ml-4">Sign in</Text>
            </View>

            {/* Contenu principal */}
            <View className="rounded-t-[40px] flex-1 bg-woofCream p-6">
                <View className="px-4 gap-y-1">
                    <Text className="text-2xl text-woofBrown font-manropeSemiBold">Welcome back !</Text>
                    <Text className="text-sm text-black font-manropeSemiBold">Hello there, sign in to continue</Text>
                </View>
                ...
                <View className="px-2 gap-y-5">
                    ...
                    <TouchableOpacity onPress={() => router.push('/forgotpassword')} className="items-end">
                        <Text className="text-sm text-woofGrey font-manropeSemiBold">Forgot your password ?</Text>
                    </TouchableOpacity>

                    <TouchableOpacity
                        className="rounded-2xl py-3 mt-[58px] items-center bg-woofBrown text-white"
                    >
                    ...
                    <View className="items-center mt-11">
                        <View className="flex-row gap-x-2">
                            <Text className="text-sm text-black font-manrope">Don't have an account? </Text>
                            <TouchableOpacity onPress={() => router.push('/signup')} className="items-end">
                                <Text className="text-sm text-woofBrown font-manropeSemiBold">Sign Up</Text>
                            </TouchableOpacity>
                        </View>
                    </View>
